...
public class Curso implements Serializable{
	...
	@NotEmpty(message = "Voce deve informar uma descricao")
	...
	@NotNull(message = "Voce deve selecionar o tipo do curso!")
	...
	@NotNull(message = "A data de criacao deve ser informada")

	@Past(message = "A data de criacao deve ser menor que a data atual")
